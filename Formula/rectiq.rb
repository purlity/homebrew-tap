class Rectiq < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/purlity/rectiq/releases/download/v#{version}/rectiq-cli-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "0b21ba222485534f5656097010b5f6e733ade3087dd1e2f21022b6446f2a5728"
    else
      url "https://github.com/purlity/rectiq/releases/download/v#{version}/rectiq-cli-#{version}-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/purlity/rectiq/releases/download/v#{version}/rectiq-cli-#{version}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "9e374b545fe7e7915590f611daee3609c6405a89ab0809cd27cf015df4d5a0e3"
    else
      url "https://github.com/purlity/rectiq/releases/download/v#{version}/rectiq-cli-#{version}-x86_64-unknown-linux-musl.tar.gz"
